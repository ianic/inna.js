...
/*kvantiziraj na 5 minuta*/
Date.prototype.toRadnoVrijeme = function(){ 
  var minutes = this.getMinutes() - this.getMinutes() % 5;
  this.setMinutes(minutes);
  return this;
}

/*             
//postavlja radno vrijeme u formatu npr: 09:30
Date.prototype.setRadnoVrijeme = function(value){
  var parts = value.split(":");                                                                        
  var newTime = new Date(this.getFullYear(), this.getMonth(), this.getDate(), parts[0], parts[1]);
  this.setTime(newTime.getTime());  
  return this;
} 
*/
